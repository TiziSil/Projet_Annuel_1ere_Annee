        ...
        <div clas="boite d-flex flex-column">
            <form class="d-flex flex-row boite" method="POST">
                <div class="col-8 barre-de-recherche-topic d-flex">
                    ...
                    <input class="barre-de-recherche-topic" placeholder="Recherchez une discussion" required type="text" name="recherche">
                </div>
            ...
            ?>
                <div class="card d-flex my-1">
                    <div class="card-header d-flex flex-row justify-content-between">
                        <h5 class="d-flex"><?php echo $question['question_title']; ?></h5>
