...
<html>
  ...
  <body>
    <section>
      <div class="product">
          <img src="../../../assets/images/Abonnement.png" alt="Image illustrative de l'abonnement" width="60px" height="70px">
      ...
      <form action="create-checkout-session.php" method="POST">
        ...
        <button id="checkout-and-portal-button" type="submit">Je m'abonne !</button>
      </form>
    </section>
  </body>
</html>