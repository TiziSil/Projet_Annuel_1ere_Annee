<?php if (isset($_GET['id']) and !empty($_GET['id'])) {
    ...
    <section class="forum-section-2 py-4 d-flex flex-column">
        <div class="container py-5">
            <!-- Question initiale -->
            <?php if ($question['question_supprimer'] === 0) { ?>
                ...
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <div class="d-flex flex-row">
                        ...
                        <?php if (isset($_SESSION['id_utilisateur']) and $_SESSION['id_utilisateur'] === $question['question_id_author']) { ?>
                            <a href="#"
                                onclick="activerModeEditionReponseForum('<?php echo 'forum-topic-' . $question['question_id'] ?>')">
                                <svg class="d-block my-1 mx-1" width="16px" height="16px">
                                    <image height="16px" width="16px" href="./assets/images/edit-solid.svg" />
                                </svg>
                            </a>
                            <a href="#" onclick="suppressionQuestion(<?php echo $question['question_id']; ?>)">
                                <svg class="d-block my-1 mx-1" width="16px" height="16px">
            ...
            <?php } else { ?>
                <div class="boite">
                    <h4>Oups ! Ce topic n'existe plus !</h4>
                    <a href="./forum">Retourner au forum</a>
                </div>
            <?php } ?>

            <?php if ($question['question_supprimer'] === 0) {
                while ($reponse = $getReponses->fetch()) {
                    if ($reponse['reponse_supprimer'] === 0) { ?>
                        <form action="core/forumModifierReponse.php" method="POST" class="boite py-2 my-2"
                            id="<?php echo 'forum-reponse-' . $reponse['reponse_id'] ?>">
                            <div class="d-flex flex-row justify-content-between">
                                <h4>
    ...
    <div class="container py-5 my-5 ">
        <div class="my-5 d-flex flex-row justify-content-center">
            <div class="my-5 boite col-sm-8 col-12 col-lg-6 d-flex flex-column">
                <H4>Êtes-vous sur de vouloir supprimer votre réponse ?</H4>
...
<!-- Modale confirmation suppression topic -->
<div id="modale-suppression-topic" class="py-5">
    <div class="container py-5 my-5 ">
        <div class="my-5 d-flex flex-row justify-content-center">
            <div class="my-5 boite col-sm-8 col-12 col-lg-6 d-flex flex-column">
                <H4>Êtes-vous sur de vouloir supprimer votre topic ?</H4>
                <div class="d-flex flex-row my-2 ">
                    <button class="flex-fill mx-1 button2" onclick="confirmerSuppressionQuestion()">Supprimer</button>
                    <button class="flex-fill mx-1 button2" onclick="fermerModaleSuppresion()">Annuler</button>
                </div>
            </div>
        </div>
