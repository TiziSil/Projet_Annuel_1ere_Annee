		...
		<div class="boite py-5 my-5">
			...
			<div class="row">
				<div class="col-12">
					<div class="form-check form-switch">
						<input id="btn_affichagecategorie" class="form-check-input" type="checkbox" role="switch"
							id="flexSwitchCheckChecked">
						<label class="form-check-label" for="flexSwitchCheckChecked">Visualiser toutes les
							catégories</label>
					</div>
				</div>
			</div>
			...
			<form action="core/categoryAdd.php" method="POST">
				<div class="row mt-3 mb-3">
					<div class="col-8 col-sm-6 col-lg-4">
						<input type="text" class="form-control" name="nom_categorie" placeholder="Nouvelle catégorie"
...
<section class="gestion-bloc-2 py-5">
	<div class="container py-5">
		<div class="boite  my-5">
			...
			<div class="row mt-3">
				<div class="col-12">
					<div class="form-check form-switch">
						<input id="btn_affichageingredient" class="form-check-input" type="checkbox" role="switch"
							id="flexSwitchCheckChecked">
						<label class="form-check-label" for="flexSwitchCheckChecked">Visualiser toutes les
							ingrédients</label>
					</div>
			...
			<!-- Formulaire -->
			<form action="core/ingredientDel.php" method="POST"
				onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ?');">
				<div class="row mt-3 mb-3">
					<div class="col-8 col-sm-6 col-lg-4">
			...
			<form action="core/ingredientAdd.php" method="POST">
				<div class="row mt-3 mb-3">
					<div class="col-8 col-sm-6 col-lg-4">
						<input type="text" class="form-control" name="nom_ingredient" placeholder="Nom de l'ingrédient"
							required="required" value="">
					</div>
					...
					<div class="col-1">
						<button class='btn btn-link' id="btn-ajout-allergene"><img src="assets/bouton-ajout.png"
								width='20px' title="Ajouter un allergène" alt="Ajouter un allergène"></button>
					</div>
					<div class="col-1">
...
<section class="gestion-bloc-3 py-5">
	<div class="container py-5">
		<div class="boite my-5">
			<div class="col-12">
			...
			<form action="core/recipeDel.php" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ?');">
				<div class="d-flex flex-row">
					...
					<div class="mx-1 d-flex flex-fill">
						<button type="submit" class="button2 flex-fill">Supprimer la recette</button>
					</div>
				</div>
			</form>
		</div>
